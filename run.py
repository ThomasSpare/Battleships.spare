...
class GameBoard:
    ...
    def typhoon(self):
        ...
        """
        if TYPHON_TURN % 3 == 0:
            print("Damn, Captain Mcwhirs fleet can now regroup !")
            for row in self.board:
                if "░" in row:
                    hit_index = row.index("░")
    ...
    while TURNS > 0:
        ...
        for TYPHON_TURN in range(1, max_TURNS + 3):
            if TURNS == max_TURNS:
                ...
                while BS.board[xrow][yclm] == "-" or BS.board[xrow][yclm] == "¤":
                ...
                if computer_board.board[xrow][yclm] == "¤":
                    ...
                    print(colored("Ha, You missed my Battleship!", "red"))
                    BS.board[xrow][yclm] = "-"
                    time.sleep(2)
                if BS.count_hit_ships() == 5:
                    print(colored("YOU WON - Damn You for destroying my fleet!"), "light_green")
                ...
                TURNS -= 1
                max_TURNS += 1
                print("Typhoon is coming in " + str(5 - int(max_TURNS)))
                print(f"You have {TURNS} turns remaining")
                if TURNS == 0:
                    print(colored(
                        "GAME OVER: The TYPHOON is destroying our fleet,"
